...
- **Not-expressed genes**: genes detected in less than 5% of cells of that type
  ...
  (values can be adjusted for noisy data or rare cell subtypes)
...
run using a broad "T_cell" cluster (including CD4, CD8 and NK cells) to remove contamination from neighbouring macrophages, stroma, B-cells etc. 
-> no cleaning was done to try separate these subsets!
